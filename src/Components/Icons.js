...
export const Ddip = ({width="64", height="30"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 64 30">
        <text id="DDIP" transform="translate(32 25)" fill="#4169e1" font-size="27" font-family="Emmett"><tspan x="-31.32" y="0">DDIP</tspan></text>
    </svg>
